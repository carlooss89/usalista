...
class User(Base): #Define o modelo / tabela User.
    ...
    items = relationship("ItemLista", back_populates="owner") # Relacionamento inverso / Cria um relacionamento com a tabela ItemLista, onde "owner" é o nome do atributo na classe ItemLista que referencia o usuário.
